...
const testimonials = [
  {
    quote:
      "Сайт окупился за первый месяц. Заявки идут стабильно, а клиенты отмечают, насколько удобно записаться онлайн.",
    name: "Андрей Мельник",
    role: "Владелец фитнес-клуба",
  },
  {
    quote:
      "Богдан уловил атмосферу нашего ресторана с первого брифа. Получили сайт, который не стыдно показать гостям, — бронирований стало заметно больше.",
    name: "Ольга Романенко",
    role: "Управляющая рестораном",
  },
  {
    quote:
      "Перенесли магазин на новую платформу без потери продаж. Скорость загрузки выросла в разы, конверсия — вместе с ней.",
    name: "Дмитрий Савчук",
    role: "Основатель магазина одежды",
  },
];
